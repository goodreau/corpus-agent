...
not replace Corpus Agent's planner, tools, memory, model provider routing, or
...
With this plugin enabled, Corpus Agent can:
...
export HERMES_NEMO_RELAY_ATIF_AGENT_NAME='Corpus Agent E2E'
...
```json
{
  ...
  "session_id": "docs-parent-session",
  "agent": {"name": "Corpus Agent E2E", "version": "docs-example", "model_name": "qwen3.6:35b"},
  "steps": [
    {
      "source": "agent",
