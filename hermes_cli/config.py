"""
Configuration management for Corpus Agent.
...
Corpus Agent runs as a published image (nousresearch/hermes-agent), not a
...
DEFAULT_CONFIG = {
    ...
    "whatsapp": {
        ...
        # Default (None) uses the built-in "⚕ *Corpus Agent*" header.
