"""Corpus Agent CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Corpus Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Corpus "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Corpus Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Corpus — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Corpus Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
