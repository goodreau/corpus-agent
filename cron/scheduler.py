...
def _get_hermes_home() -> Path:
    """Resolve Corpus home dynamically while preserving test monkeypatch hooks.
...
def _open_continuable_cron_thread(
    ...
    thread_name = f"Corpus — {task_name}"
    try:
...
def _run_job_script(script_path: str) -> tuple[bool, str]:
    ...
    * anything else — run with the current Python interpreter
    ...
    provider credentials and other Corpus-managed secrets are not inherited
