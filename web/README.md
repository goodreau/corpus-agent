...
Browser-based dashboard for managing Corpus Agent configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Corpus Agent” — mixed case, no Mondwest, no `text-display` |
