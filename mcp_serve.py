"""
Corpus MCP Server — expose messaging conversations as MCP tools.
...
Plus: channels_list (Corpus-specific extra)
...
class EventBridge:
    ...
    This is the Corpus equivalent of OpenClaw's WebSocket gateway bridge.
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    """Create and return the Corpus MCP server with all tools registered."""
    ...
    mcp = FastMCP(
        "corpus",
        instructions=(
            "Corpus Agent messaging bridge. Use these tools to interact with "
...
def run_mcp_server(verbose: bool = False) -> None:
    """Start the Corpus MCP server on stdio."""
    if not _MCP_SERVER_AVAILABLE:
        print(
