...
description: "How to build a memory provider plugin for Corpus Agent"
---

# Building a Memory Provider Plugin

Memory provider plugins give Corpus Agent persistent, cross-session knowledge beyond the built-in MEMORY.md and USER.md. This guide covers how to build one.
...
the `messages` parameter; Corpus will continue calling them with the legacy
signature.
