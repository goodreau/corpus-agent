...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Corpus Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Corpus tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Corpus core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a Corpus Plugin](/guides/build-a-hermes-plugin)
