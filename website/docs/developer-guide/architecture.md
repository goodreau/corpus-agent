...
sidebar_position: 1
title: "Architecture"
description: "Corpus Agent internals — major subsystems, execution paths, data flow, and where to read next"
---

# Architecture

This page is the top-level map of Corpus Agent internals. Use it to orient yourself in the codebase, then dive into subsystem-specific docs for implementation details.
...
Exposes Corpus as an editor-native agent over stdio/JSON-RPC for VS Code, Zed, and JetBrains.
