...
description: "Run Corpus Agent directly on an Android phone with Termux"
---

# Corpus on Android with Termux
...
Corpus Agent can run directly on an Android phone through [Termux](https://termux.dev/).
...
That does not stop Corpus from working well as a phone-native CLI agent — it just means the recommended mobile install is intentionally narrower than the desktop/server install.

---

## Option 1: One-line installer

Corpus now ships a Termux-aware installer path:
