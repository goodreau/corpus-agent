...
slug: /
sidebar_position: 0
title: "Corpus Agent Documentation"
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Corpus safely  |
| 🧭 **[Use MCP with Corpus](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Corpus](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Corpus voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Corpus' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Corpus                              |
