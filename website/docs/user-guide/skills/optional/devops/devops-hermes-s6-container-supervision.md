---
title: "Corpus S6 Container Supervision"
sidebar_label: "Corpus S6 Container Supervision"
description: "Modify, debug, or extend the s6-overlay supervision tree inside the Corpus Agent Docker image — adding new services, debugging profile gateways, understandin..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Corpus S6 Container Supervision

Modify, debug, or extend the s6-overlay supervision tree inside the Corpus Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern.
...
# Corpus s6-overlay Container Supervision

## When to use this skill

Load this skill when you're working on:
- Adding or removing a static service in the Corpus Docker image (something that should be supervised at every container start, like the dashboard)
...
If you're just running the Corpus Agent and want to use Docker, see `website/docs/user-guide/docker.md` instead.
...
- `hermes-tool-quirks`: Specific Corpus-tool workarounds (sed/grep/etc.) — load when debugging the s6 stack's interaction with hermes built-in tools.
