...
| Version | `1.0.1` |
| Author | Joe Rinaldi Johnson (joerj123), Corpus Agent |
| License | MIT |
...
| Telegram (Corpus Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
