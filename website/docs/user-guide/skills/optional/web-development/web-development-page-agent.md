...
- User wants **Corpus itself to drive a browser** → use Corpus' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
