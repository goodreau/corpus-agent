---
title: "Petdex — Install and select animated petdex mascots for Corpus"
sidebar_label: "Petdex"
description: "Install and select animated petdex mascots for Corpus"
---
...
Install and select animated petdex mascots for Corpus.
...
the Corpus CLI, TUI, and desktop app. This skill drives the `hermes pets` CLI
...
- Pillow (a core Corpus dependency) for sprite decoding — already installed.
...
- The petdex npm CLI installs to `~/.codex/pets`; Corpus uses its own
