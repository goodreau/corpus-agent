...
## Corpus Agent Integration

This skill is designed for the Corpus agent. It uses Corpus tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Corpus skills for specific phases:
