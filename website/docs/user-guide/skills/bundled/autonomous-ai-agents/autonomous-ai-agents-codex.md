...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Corpus terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Corpus itself, `model.provider: openai-codex` uses Corpus-managed Codex
...
## Corpus Gateway Caveat

When invoking the Codex CLI from a Corpus gateway/service context (for example,
