...
When Corpus Agent runs inside a messaging gateway (Slack, Discord, Telegram,
...
If you use Corpus' kanban multi-agent workflow, workers can attach
...
back into the thread as a native attachment. Corpus Agent's deliverable
