...
description: "Reference for Corpus core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call Corpus tools programmatically. |
