...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  Corpus Agent  ──▶  GitHub API  ──▶  Review     │
...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](./webhook-github-pr-review.md) — GitHub pushes events to Corpus instantly when PRs are opened or updated.
:::
...
- **Corpus Agent installed** — see the [Installation guide](/getting-started/installation)
...
Make sure Corpus can access GitHub. Start a chat:
...
Still in the chat, ask Corpus to review a real PR:
...
A skill gives Corpus consistent review guidelines that persist across sessions and cron runs. Without one, review quality varies.
...
This is what makes the reviewer actually useful. Start a session and teach Corpus your team's standards:
...
2. Teach Corpus your conventions via memory (Step 4)
