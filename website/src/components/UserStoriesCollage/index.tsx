  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Corpus Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Corpus &mdash; scraped from X, GitHub, Reddit,
