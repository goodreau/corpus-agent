...
TOOLSETS = {
    ...
    # Coding posture (base Corpus — CLI/TUI/desktop/ACP). Auto-selected in a
    ...
    # ==========================================================================
    # Full Corpus toolsets (CLI + messaging platforms)
    #
    ...
    "hermes-email": {
        "description": "Email bot toolset - interact with Corpus via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-sms": {
        "description": "SMS bot toolset - interact with Corpus via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
