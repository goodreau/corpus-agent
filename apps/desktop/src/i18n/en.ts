...
export const en: Translations = {
  ...
  boot: {
    ready: 'Corpus Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Corpus settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Corpus Desktop…'
    },
    errors: {
      backgroundExited: 'Corpus background process exited.',
      backgroundExitedDuringStartup: 'Corpus background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Corpus backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Corpus',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Corpus Desktop.',
    ...
    native: {
      ...
      inputBody: 'Corpus is waiting for your response.',
      turnDoneTitle: 'Corpus finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Corpus defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Corpus is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Corpus asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Corpus was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Corpus follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Corpus is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Corpus, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Corpus checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Corpus configuration...',
    ...
    gateway: {
      ...
      intro:
        'Corpus Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Corpus backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Corpus backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Corpus backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Corpus Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Corpus ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Corpus runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As Corpus builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Corpus to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Corpus to generate pets.',
      backgroundHint: 'You can close this — Corpus will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Corpus desktop' },
    ...
    hermesActiveSessions: (version, count) => `Corpus ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Corpus environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Corpus will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Corpus backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Corpus. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Corpus...',
    placeholderReconnecting: 'Reconnecting to Corpus…',
    ...
    attachUrlDesc: 'Corpus will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Corpus to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Corpus…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Corpus…',
    ...
    unsupportedMessage: 'This version of Corpus can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Corpus is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Corpus backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Corpus from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Corpus will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Corpus desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Corpus updater takes over in its own window and reopens Corpus automatically when it’s done. Please don’t reopen Corpus yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Corpus reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Corpus reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Corpus needs a one-time install',
    ...
    settingUpTitle: 'Setting up Corpus Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Corpus CLI or desktop instance is running. Stop any running Corpus instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Corpus installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Corpus Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Corpus is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Corpus…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Corpus',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Corpus at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Corpus connects automatically',
    ...
    authorizeThere: 'Authorize Corpus there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Corpus there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Corpus Desktop v${version}`,
      ...
      gatewayTitle: 'Corpus inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Corpus will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Corpus is restarting...',
      askRestart: 'Ask Corpus to restart the server',
      lookingRestart: taskId => `Corpus is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Corpus is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Corpus finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Corpus could not restart the server.',
      stillWorking:
        'Corpus is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Corpus is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Corpus gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Corpus won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Corpus needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Corpus needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Corpus Desktop to use Save Image.',
    restartToSaveImages: 'Restart Corpus Desktop to save images',
